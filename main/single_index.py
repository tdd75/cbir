...
def parse_args():
    ...
    parser.add_argument('--file_path', '-fp', default=None, metavar='FILE', type=str, help='file path of query')
...
def main():
    ...
    assert os.path.exists(args.file_path), 'the file path must be existed!'
